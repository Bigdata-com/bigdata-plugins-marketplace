...
#
# Usage:
#   scripts/build-standalone-skill.sh [-v VERSION] [-o OUTPUT_DIR] <skill-dir> [<skill-dir> ...]
#   scripts/build-standalone-skill.sh [-v VERSION] --all
#
# Examples:
#   scripts/build-standalone-skill.sh bigdata-earnings-preview
#   scripts/build-standalone-skill.sh -v 1.0.0 bigdata-earnings-preview
#   scripts/build-standalone-skill.sh --all
#
...
# Skills that are not standalone-packageable (legacy monolith, work in progress)
EXCLUDE_SKILLS=("financial-research-analyst")
